...
export function Hero() {
  return (
    <section className="flex flex-col items-center px-4 pt-36 md:pt-44">
      <div className="flex max-w-3xl flex-col items-center text-center">
        <div className="group relative inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 px-5 py-2.5 ring-1 ring-primary/20 transition-all hover:ring-primary/40">
          <span className="absolute inset-0 rounded-full bg-gradient-to-r from-primary/0 via-primary/10 to-primary/0 opacity-0 blur-xl transition-opacity group-hover:opacity-100" />
        ...
        <h1 className="mt-8 text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
          Toda la experiencia
          <br />
          Llanero en tu bolsillo
        </h1>

        <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
          Descubre bodegones y restaurantes cerca de ti,
          <br className="hidden md:block" />
          disfruta de ofertas exclusivas y sigue tus pedidos en tiempo real.
        </p>
      ...
      <img
        src="/mock-1.png"
        alt="Llanero App"
        className="mt-8 h-[400px] w-auto object-contain md:-mt-64 md:ml-96 md:h-[900px]"
      />
    </section>
  );
}
